                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full p-4 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary bg-white text-gray-700 transition"
                            value={email}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full p-4 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary bg-white text-gray-700 pr-12 transition"
                                value={password}
